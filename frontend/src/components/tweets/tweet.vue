<template>
  <div class="status" v-bind:class="{ 'status-reply': tweet.aside }" v-bind:id="'status-' + listIdx" v-bind:data-status-id="tweet.id_str">
    <template v-if="tweet.allowed">
